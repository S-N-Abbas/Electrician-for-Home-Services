...
namespace Electrician_for_Home_Services.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            ...
            db = new E4HSConnection();

            var user = db.People.Find(model.Username);
            if (user != null)
                if (user.IsApproved == false)
                {
                    ViewBag.Error = "Your account request is pending. Please wait until admin accepsts your request.";
                    return View("Error");
                }
                ...
                case SignInStatus.Success:
                        ...
                        if (HttpRuntime.Cache["LoggedInUsers"] != null)
                        {
                            ...
                            if (!loggedInUsers.ContainsKey(model.Username))
                            {
                                ...
                                loggedInUsers.Add(model.Username, DateTime.Now);
